...
def create_agent_graph(llm, tools_list):
    ...
    graph_builder.add_node("verify_final_answer", partial(verify_final_answer, llm=llm))
    ...
    graph_builder.add_edge("aggregate_answers", "verify_final_answer")
    graph_builder.add_edge("verify_final_answer", END)
